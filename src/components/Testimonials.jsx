...
const TESTIMONIALS = [
  {
    ...
    rating: 5,
    text:
      "In this site we get valuable and productive information about web development.",
  },
  {
...
const Card = ({ item }) => (
  ...
  >
    ...
    <div className="mt-3 flex items-center gap-1" aria-label={`${item.rating} out of 5 stars`}>
    ...
    <p className="mt-4 text-sm text-gray-200 leading-relaxed line-clamp-3">
      {item.text}
    </p>
  </article>
);
